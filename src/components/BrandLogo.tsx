      ...
      >
        <div className="w-full h-full bg-[#090d16] rounded-[11px] flex items-center justify-center relative overflow-hidden">
          ...
          >
            ...
            <path d="M16 5V27" stroke="url(#brandLogoGrad)" strokeWidth="2" strokeDasharray="2 2" opacity="0.6" />
            {/* Core AI Sparkle Diamond */}
            <path d="M16 10L18.2 14.8L23 17L18.2 19.2L16 24L13.8 19.2L9 17L13.8 14.8Z" fill="url(#brandLogoGrad)" />
          </svg>
        </div>
      </div>
